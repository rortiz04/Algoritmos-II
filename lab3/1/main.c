...
int main(int argc, char *argv[]) {
  ...
  //  array_dump(array);
	/* devuelve la temperatura minima minima */     
	
	 printf("la temperatura minima %d\n", min_temp_hist(array));

	/*devuelve la temperatura maxima por year */
	max_temp_for_year(array, output);
	for (int i = 0; i < 37; ++i){
		printf("la maxima temperatura del year %d es %d\n", (i+1980), output[i]);
	}
